      ...
      <div className="w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8">
        ...
        <div className="mt-4">
          <button
            ...
            className="w-full flex flex-wrap gap-1 items-center justify-center bg-secondary hover:bg-blue-700 text-white font-bold px-4 py-2 rounded focus:outline-none"
          >
